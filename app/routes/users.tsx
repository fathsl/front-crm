              ...
              <>
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-4 pt-3 border-t">
                    <div className="flex items-center gap-2">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(user.durum)}`}
                      >
                        {user.durum}
                      </span>
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getRoleColor(user.yetkiTuru)}`}
                      >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        yetkiTuru: Number(e.target.value) as Role,
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                  >
