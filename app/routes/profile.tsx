          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm border p-6 text-center">
              ...
              <div className="flex justify-center mb-4">
                <span
                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getRoleBadgeColor(user?.role as string)}`}
                >
              ...
              <div className="flex items-center justify-center gap-2 text-sm">
                <div
                  className={`w-2 h-2 rounded-full ${user?.status === "Aktif" ? "bg-green-500" : "bg-red-500"}`}
                ></div>
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm text-blue-800">
                        ...
                        <p>
                          Yetki düzeyi ve hesap durumu sadece sistem
